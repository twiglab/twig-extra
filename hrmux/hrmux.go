...
func (hrx *HttpRouterMux) Lookup(method, path string, r *http.Request, c twig.MCtx) {
...
func (hrx *HttpRouterMux) AddHandler(method, path string, h twig.HandlerFunc, m ...twig.MiddlewareFunc) twig.Route {
	panic("HttpRouterMux is not support Add function!")
}
